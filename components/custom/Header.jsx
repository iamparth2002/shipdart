...
const Header = ({ toggleSidebar, activeTab }) => {
  ...
  return (
    <header className="flex items-center justify-between bg-white p-4 shadow">
        ...
        <div className="relative">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="bg-gray-100  hover:bg-gray-200 flex gap-2 items-center">
      ...
      <Dialog className="px-2" open={!!editingUser} onOpenChange={() => setEditingUser(null)}>
        {editingUser && (
          <Profile
            user={editingUser}
            onSave={handleSave}
